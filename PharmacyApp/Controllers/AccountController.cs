...
using EnterSchoolApp.ViewModels;
    ...
    public class AccountController : BaseController
    {
        ...
        private void CreateDefaultUser()
        {
            ...
            if (UserManager.FindByName("Super") == null)
            {
                ...
                UserManager.AddToRoles(user.Id, UserRoles.SuperAdministrator);
            }
        }
        ...
        public async Task<ActionResult> Details()
        {
            ...
            return View(new ProfileViewModel
            {
                ...
                Institution = user.Institution == null ? "EnterSchoolApp" : user.Institution.Name,
                Roles = roles,
                Status = user.Status,
