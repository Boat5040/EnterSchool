namespace EnterSchoolApp.Utility
{
    using System;
    ...
    public class PasswordGenerator
    {
        ...
        protected char GetRandomCharacter(char[] sampleSpace)
        {
            int upperBound = sampleSpace.GetUpperBound(0);
            ...
            int randomCharPosition = GetCryptographicRandomNumber(sampleSpace.GetLowerBound(0), upperBound);

            char randomChar = sampleSpace[randomCharPosition];
        ...
        public string GenerateSimple()
        {
            ...
            List<char[]> sampleSpace = new List<char[]>
            {
            ...
            for (int i = 0; i < pwdLength; i = i + 4)
            {
                foreach (char[] space in sampleSpace)
                {
                    pwd += GetRandomCharacter(space);
